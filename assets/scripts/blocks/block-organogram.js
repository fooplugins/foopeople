 ...
 */
registerBlockType( 'fooplugins/foopeople-organogram', {

	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'FooPeople Organogram' ), // Block title.
	description: __( 'Insert a FooPeople Organogram into your content' ),
