...
/**
 * FooPeople Blocks Initializer
 *
 * Enqueue CSS/JS of all the FooPeople blocks.
 *
 * @since   1.0.0
 * @package CGB
 */

if ( ! class_exists( 'FooPlugins\FooPeople\Gutenberg\Blocks' ) ) {
	class Blocks {
		...
		function __construct() {
			...
			add_filter( 'foopeople_build_container_data_options', array( $this, 'add_data_options_for_block_editor' ), 10, 3 );
		}
